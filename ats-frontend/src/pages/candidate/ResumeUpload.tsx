...
import ResumeUploadCard from "../../components/candidate/upload/ResumeUploadCard";
import type { ProcessingStep } from "../../components/candidate/upload/UploadProgress";
import { processResume, uploadResume } from "../../services/resume/resume";
