...
import useATSDashboard from "../../hooks/useATSDashboard";

import type { ATSJob } from "../../types/job";

import HRDashboardHeader from "../../components/hr/dashboard/HRDashboardHeader";
import HRJobContextCard from "../../components/hr/dashboard/HRJobContextCard";
import HROverviewStats from "../../components/hr/dashboard/HROverviewStats";
import HRAnalyticsSection from "../../components/hr/dashboard/HRAnalyticsSection";
import HRSkillInsights from "../../components/hr/dashboard/HRSkillInsights";
import HROutstandingCandidates from "../../components/hr/dashboard/HROutstandingCandidates";
import HRRecentCandidates from "../../components/hr/dashboard/HRRecentCandidates";

import {
  HRDashboardError,
  HRDashboardEmpty,
  HRNoJobs,
} from "../../components/hr/dashboard/HRDashboardStates";

import HRDashboardSkeleton from "../../components/hr/dashboard/HRDashboardSkeleton";
import HRDashboardFilters from "../../components/hr/dashboard/HRDashboardFilters";
import HRDashboardPagination from "../../components/hr/dashboard/HRDashboardPagination";
import HRDashboardSorting from "../../components/hr/dashboard/HRDashboardSorting";
