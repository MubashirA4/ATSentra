...
const Navbar = ({ onMenuClick }: NavbarProps) => {
  ...
  const getPageContext = () => {
    if (location.pathname === "/candidate/dashboard" || location.pathname === "/dashboard") {
      return {
    ...
    if (location.pathname === "/candidate/resumes" || location.pathname === "/resumes") {
      return {
        label: "Candidate workspace",
        title: "My resumes",
      };
    ...
    if (location.pathname === "/candidate/resume/upload" || location.pathname === "/resume/upload") {
      return {
        label: "Candidate workspace",
        title: "Upload resume",
      };
    ...
    if (location.pathname.startsWith("/candidate/resume-analysis") || location.pathname.startsWith("/resume-analysis")) {
      return {
        label: "Candidate workspace",
