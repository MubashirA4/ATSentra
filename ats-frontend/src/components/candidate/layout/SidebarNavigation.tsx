...
import { getResumes } from "../../../services/resume/resume";
...
const ResumeAnalysisNavItem = ({ onNavigate }: ResumeAnalysisNavItemProps) => {
  ...
  const isActive = location.pathname.startsWith("/resume-analysis/");
  ...
  const handleClick = async () => {
    ...
    try {
      ...
      navigate(`/resume-analysis/${latestProcessedResume._id}`);
    } catch (error) {
